...
\textbf{Example 1:} A professor will select 5 out of 10 questions for an exam, and a student studies the answers to 6 of these 10 questions. What is the probability that the professor will select questions that the student has studied for all 5 questions?\\
\\
\textbf{Solution 1:}
