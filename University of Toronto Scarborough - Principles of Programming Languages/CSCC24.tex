...
-- | Zero or more operands separated by an operator.
chainl :: Parser a                -- ^ operand parser
       -> Parser (a -> a -> a)    -- ^ operator parser
       -> a                       -- ^ start value
       -> Parser a                -- ^ evaluated answer
chainl = undefined

-- | One or more operands separated by an operator.
chainl1 :: Parser a               -- ^ operand parser
        -> Parser (a -> a -> a)   -- ^ operator parser
        -> Parser a               -- ^ evaluated answer
chainl1 = undefined

-- | Consume zero or more spaces, maximum munch.
